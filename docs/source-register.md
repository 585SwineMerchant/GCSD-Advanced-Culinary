...
- GCSD Advanced Culinary Student Field Manual Working Draft v0.2
- GCSD Advanced Culinary Six Experiences Working Draft v0.1
- Advanced Culinary Scope and Sequence 2023–2024
...
- Advanced Culinary field manual: https://docs.google.com/document/d/1iomQqxabqZ3tljbbvhQsiRbeHfPtxU-Tyb3Cue-9Kno/edit
- Six-experience workbook: https://docs.google.com/spreadsheets/d/1Bt5IHlLEGbf0atfyuuBRxVlH1QhnAOwCsX79OyqGOp4
...
## Functional Architecture Decision — July 29, 2026

- The six major experiences remain the operational spine of Advanced Culinary.
- Technique instruction, ingredient study, demonstrations, recipe trials, and smaller labs are called by menu and production needs.
- ProStart Second Edition provides authoritative course information but does not dictate the pacing sequence.
- The student interface is organized around one active experience and six phases: Brief, Learn, Plan, Produce, Close, Improve.
- The plan-to-close time standard makes packaging, delivery, dishes, sanitation, storage, and station restoration part of production.
- The professional recovery protocol separates the original technical result from recognition, diagnosis, communication, instructor direction, and corrective action.
